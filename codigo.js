...
const map = {
    Comidas(quantidadeComidas) {
        for (let i = 0; i < quantidadeComidas; i++) {
            ...
            if (matriz[xComida][yComida] == undefined)
                matriz[xComida][yComida] = `<img width="32px" src="imagens/icons8-animal-de-rato-24.png">`
            else
                i--
        }
    },
    ...
    Pedras(quantidadePedras) {
        for (let i = 0; i < quantidadePedras; i++) {
            ...
            if (matriz[xPedra][yPedra] == undefined)
                matriz[xPedra][yPedra] = `<img src="imagens/icons8-rocha-32.png">`
            else
                i--
        }
    },
    ...
    Cobra(tamanhoCobra) {
        for (let i = 0; i < tamanhoCobra; i++) {
            matriz[ySnake][xSnake + i] = `<img width="32px" src="imagens/icons8-snake-64.png">`
    ...
    Mapa() {
        ...
        for (let x = 0; x < matriz.length; x++) {
            ...
            for (let y = 0; y < matriz.length; y++) {
                ...
                if (td.innerHTML == `<img width="32px" src="imagens/icons8-snake-64.png">`)
...
function atualizarCoordenadas(direcao) {
    ...
    if (matriz[ySnake][xSnake] == `<img width="32px" src="imagens/icons8-animal-de-rato-24.png">`) {//Conta quantidade comida
        comidasComidas++
        contagemComida++
    ...
    else if (matriz[ySnake][xSnake] == `<img src="imagens/icons8-rocha-32.png">`) {//Apaga uma unidade de rabo
        matriz[snake[0][0]][snake[0][1]] = `&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;`, snake.shift()
        matriz[snake[0][0]][snake[0][1]] = `&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;`, snake.shift()
    }
    else
    ...
    matriz[ySnake][xSnake] = `<img width="32px" src="imagens/icons8-snake-64.png">`
    if (snake.length == 0)
